...
const { ShowTypingMiddleware} = require('botbuilder-core');
...
// var typingMiddleWare = new ShowTypingMiddleware(1000, 250);
...
const dialog = new MainDialog(bookingDialog, userState);
