...
OTP_VALIDATE_DIALOG = 'OTP_VALIDATE_DIALOG';
WATERFALL_DIALOG = 'WATERFALL_DIALOG';
NUMBER_PROMPT = 'NUMBER_PROMPT';

class OtpValidateDialog extends ComponentDialog {
    constructor() {
        super(OTP_VALIDATE_DIALOG);
...
module.exports.OtpValidateDialog = OtpValidateDialog;
module.exports.OTP_VALIDATE_DIALOG = OTP_VALIDATE_DIALOG;
